...
public class XsMatrix : global::System.IDisposable {
  ...
  public XsMatrix(XsMatrix other, SWIGTYPE_p_double arg1, uint rows, uint cols, uint stride, XsDataFlags flags) : this(xsensdeviceapiPINVOKE.new_XsMatrix__SWIG_7(XsMatrix.getCPtr(other), SWIGTYPE_p_double.getCPtr(arg1), rows, cols, stride, (int)flags), true) {
    if (xsensdeviceapiPINVOKE.SWIGPendingException.Pending) throw xsensdeviceapiPINVOKE.SWIGPendingException.Retrieve();
  }
