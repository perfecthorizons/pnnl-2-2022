...
public class xsensdeviceapi {
  ...
  public static void xsTypesVersion(SWIGTYPE_p_XsVersion version) {
    xsensdeviceapiPINVOKE.xsTypesVersion__SWIG_0(SWIGTYPE_p_XsVersion.getCPtr(version));
  }

  public static SWIGTYPE_p_XsVersion xsTypesVersion() {
    SWIGTYPE_p_XsVersion ret = new SWIGTYPE_p_XsVersion(xsensdeviceapiPINVOKE.xsTypesVersion__SWIG_1(), true);
    return ret;
  }
