...
public class XsDataPacket : global::System.IDisposable {
  ...
  public XsGloveData gloveData() {
    XsGloveData ret = new XsGloveData(xsensdeviceapiPINVOKE.XsDataPacket_gloveData(swigCPtr), true);
    return ret;
  }

  public bool containsGloveData() {
    bool ret = xsensdeviceapiPINVOKE.XsDataPacket_containsGloveData(swigCPtr);
    return ret;
  }

  public void setGloveData(XsGloveData data) {
    xsensdeviceapiPINVOKE.XsDataPacket_setGloveData(swigCPtr, XsGloveData.getCPtr(data));
    if (xsensdeviceapiPINVOKE.SWIGPendingException.Pending) throw xsensdeviceapiPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public XsGloveSnapshot gloveSnapshot() {
    XsGloveSnapshot ret = new XsGloveSnapshot(xsensdeviceapiPINVOKE.XsDataPacket_gloveSnapshot(swigCPtr), true);
    return ret;
  }

  public bool containsGloveSnapshot() {
    bool ret = xsensdeviceapiPINVOKE.XsDataPacket_containsGloveSnapshot(swigCPtr);
    return ret;
  }

  public void setGloveSnapshot(XsGloveSnapshot data, bool retransmission) {
    xsensdeviceapiPINVOKE.XsDataPacket_setGloveSnapshot(swigCPtr, XsGloveSnapshot.getCPtr(data), retransmission);
    if (xsensdeviceapiPINVOKE.SWIGPendingException.Pending) throw xsensdeviceapiPINVOKE.SWIGPendingException.Retrieve();
  }
