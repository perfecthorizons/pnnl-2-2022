...
public class XsFile : global::System.IDisposable {
  ...
  public SWIGTYPE_p___int64 write(SWIGTYPE_p_void source, SWIGTYPE_p___int64 size, SWIGTYPE_p___int64 count) {
    SWIGTYPE_p___int64 ret = new SWIGTYPE_p___int64(xsensdeviceapiPINVOKE.XsFile_write(swigCPtr, SWIGTYPE_p_void.getCPtr(source), SWIGTYPE_p___int64.getCPtr(size), SWIGTYPE_p___int64.getCPtr(count)), true);
    if (xsensdeviceapiPINVOKE.SWIGPendingException.Pending) throw xsensdeviceapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
