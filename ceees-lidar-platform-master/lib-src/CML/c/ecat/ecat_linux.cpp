// NOTE - By default, you need to be root to open a raw socket under Linux.
//        You can configure a program to do this as non-root using the 
//        following command:
//           sudo setcap cap_net_raw=eip <file name>
