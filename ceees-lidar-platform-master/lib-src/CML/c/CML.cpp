...
//=====================================================
// This defines the version number of the CML libraries.
//=====================================================
#define CML_LIBRARY_VERSION     "2.13"
...
void CopleyMotionLibrary::LogCAN( bool recv, struct CanFrame &frame )
{
   ...
   logSize += fprintf( (FILE *)log, "%9u ", Thread::getTimeUS() );
