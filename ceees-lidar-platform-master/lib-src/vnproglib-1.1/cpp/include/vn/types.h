...
constexpr CommonGroup operator|(CommonGroup lhs, CommonGroup rhs)
{
...
/// \param[in] rhs Right-hand side enum value.
/// \return The binary ORed value.
constexpr TimeGroup operator|(TimeGroup lhs, TimeGroup rhs)
{
...
/// \param[in] rhs Right-hand side enum value.
/// \return The binary ORed value.
constexpr ImuGroup operator|(ImuGroup lhs, ImuGroup rhs)
{
...
/// \param[in] rhs Right-hand side enum value.
/// \return The binary ORed value.
constexpr GpsGroup operator|(GpsGroup lhs, GpsGroup rhs)
{
...
/// \param[in] rhs Right-hand side enum value.
/// \return The binary ORed value.
constexpr AttitudeGroup operator|(AttitudeGroup lhs, AttitudeGroup rhs)
{
...
/// \param[in] rhs Right-hand side enum value.
/// \return The binary ORed value.
constexpr InsGroup operator|(InsGroup lhs, InsGroup rhs)
{
