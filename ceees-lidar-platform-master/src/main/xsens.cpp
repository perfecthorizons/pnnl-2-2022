...
XSensSensor::XSensSensor() {
	...
	callback = new CallbackHandler(static_cast<void *>(shared_memory), XSensSensor::packet_parser);
...
void XSensSensor::packet_parser(void *userData, const XsDataPacket *packet) {
