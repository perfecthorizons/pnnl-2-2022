...
/**
  ...
  This function is used to handle the details of streaming out a trajectory 
  that's too big to fit in the amplifier's PVT buffer all at once.
