...
- Make sure you have a CAN card configured properly in your computer with any
  ...
  The examples shipped with the libraries are setup to use the Copley CAN card
...
- If you are using a CAN card other then the Copley CAN card then add the directories 
...
using Ubuntu Linux.  At the moment, only the Copley CAN cards are supported for use under Linux.
